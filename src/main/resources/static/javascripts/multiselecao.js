...
Brewer.MultiSelecao = (function(){
	...
	function onSelecaoClicado(){
		var selecaoCheckboxCkecados = this.selecaoCheckbox.filter(':checked');
		this.selecaoTodosCheckbox.prop('checked',selecaoCheckboxCkecados.length >= this.selecaoCheckbox.length);
		statusBotaoAcao.call(this,selecaoCheckboxCkecados.length);
	}
