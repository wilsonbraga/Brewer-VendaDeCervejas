...
public enum TipoPessoa {
	...
	FISICA("Física", "CPF", "000.000.000-00", CpfGroup.class) {
		...
		@Override//formatar o cpf/cnpj para mostar na tabela 
	...
	//metodo abstarct para formatar o cpf/cnpj para mostar na tabela 
	...
	//remover formatação do cpf/cnpj para salvar no banco de dados.
