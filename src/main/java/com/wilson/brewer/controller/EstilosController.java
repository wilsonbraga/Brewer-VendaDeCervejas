...
import com.wilson.brewer.service.CadastroEstiloService;
...
public class EstilosController {
	...
	public ModelAndView novo(Estilo estilo) {
		return new ModelAndView("estilo/CadastroEstilos");
	}

	@PostMapping({ "/novo", "{\\+d}" })
	public ModelAndView cadastra(@Valid Estilo estilo, BindingResult result, RedirectAttributes attributes) {
