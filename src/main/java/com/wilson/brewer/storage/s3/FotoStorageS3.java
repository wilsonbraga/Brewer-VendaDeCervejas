package com.wilson.brewer.storage.s3;
...
public class FotoStorageS3 implements FotoStorage{
	...
	private static final String BUCKET = "pilsencervaja";//Nome que do seu bucket no S3
	...
	public String getUrl(String foto) {
		if(!StringUtils.isEmpty(foto)){
			return "https://s3-sa-east-1.amazonaws.com/pilsencervaja/" + foto;
		}
		return null;
	}
