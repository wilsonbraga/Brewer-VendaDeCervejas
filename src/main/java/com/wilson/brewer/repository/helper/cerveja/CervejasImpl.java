...
public class CervejasImpl  implements CervejasQueries{
	...
	public ValorItensEstoque valorItensEstoque() {
		String query = "select new com.wilson.brewer.dto.ValorItensEstoque(sum(valor * quantidadeEstoque), sum(quantidadeEstoque)) from Cerveja";
	...
	public List<CervejaDTO> porSkuOuNome(String skuOuNome) {
		String jpql = "select new com.wilson.brewer.dto.CervejaDTO(codigo, sku, nome, origem, valor, foto) "
