...
public class ClientesController {
	...
	//pesquisa de cliente com Json, javascript e ajax, usando na view CadastroVenda
	...
	//trata a exceção IllegalArgumentException e retorna um badRequest 400 para view
