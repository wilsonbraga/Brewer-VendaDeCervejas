...
@EnableWebMvc
@EnableSpringDataWebSupport//adicionado na aula 15.7, essa anotação vai adicionar suporte a algumas coisas do spring data, como o Pageable para usar em  paginações das paginas.
@EnableCaching
@EnableAsync
public class WebConfig extends WebMvcConfigurerAdapter implements ApplicationContextAware {
	...
	public TemplateEngine templateEngine(){
		...
		engine.addDialect(new SpringSecurityDialect());//para usar o Thymeleaf - Extras Spring Security
		return engine;
	}
	...
	//METODO RESPONSAVEL POR CARREGAR OS ARQUIVOS CSS, JS, FOTOS   
	public void addResourceHandlers(ResourceHandlerRegistry registry){
		registry.addResourceHandler("/**").addResourceLocations("classpath:/static/");
	}
	
	//REGISTRANDO O CONVERTER DA CLASSE ESTILO PARA FUNCIONAR
	@Bean
	public FormattingConversionService mvcConversionService(){
		...
		BigDecimalFormatter intergerFormatter = new BigDecimalFormatter("#,##0");
	...
	//Cache profissional usando tela cadastro de cliente, para estado
	@Bean
