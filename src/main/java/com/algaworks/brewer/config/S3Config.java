...
//@PropertySource({ "classpath:env/s3-homolog.properties"})
public class S3Config {
	...
	public AmazonS3 amazonS3() {
		AWSCredentials credencias = new BasicAWSCredentials(
...
//		System.out.println(">>>>>>>>AWS_SECRET_ACCESS_KEY" + env.getProperty("AWS_SECRET_ACCESS_KEY"));
		...
		AmazonS3 amazonS3 = new AmazonS3Client(credencias, new ClientConfiguration());
